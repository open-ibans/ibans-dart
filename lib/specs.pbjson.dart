...
final $typed_data.Uint8List bankDescriptor = $convert.base64Decode('CgRCYW5rEhIKBG5hbWUYAiABKAlSBG5hbWUSEgoEY29kZRgBIAEoCVIEY29kZRIaCghpbml0aWFscxgDIAEoCVIIaW5pdGlhbHMSFAoFc3dpZnQYBCABKAlSBXN3aWZ0');
...
final $typed_data.Uint8List ibanSpecConstantDescriptor = $convert.base64Decode('ChBJYmFuU3BlY0NvbnN0YW50EhoKCHBvc2l0aW9uGAEgASgNUghwb3NpdGlvbhIaCghjb25zdGFudBgDIAEoCVIIY29uc3RhbnQ=');
...
final $typed_data.Uint8List ibanSpecConstantPatternDescriptor = $convert.base64Decode('ChdJYmFuU3BlY0NvbnN0YW50UGF0dGVybhIaCghwb3NpdGlvbhgBIAEoDVIIcG9zaXRpb24SGAoHcGF0dGVybhgCIAEoCVIHcGF0dGVybhIaCghjb25zdGFudBgDIAEoCVIIY29uc3RhbnQ=');
...
const IbanSpecPatterns$json = const {
  ...
  '2': const [
    ...
    const {'1': 'constants', '3': 3, '4': 3, '5': 11, '6': '.specs.IbanSpecConstantPattern', '10': 'constants'},
  ],
};

/// Descriptor for `IbanSpecPatterns`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List ibanSpecPatternsDescriptor = $convert.base64Decode('ChBJYmFuU3BlY1BhdHRlcm5zEh8KC2NoZWNrX2RpZ2l0GAEgASgJUgpjaGVja0RpZ2l0EhIKBGJiYW4YAiABKAlSBGJiYW4SPAoJY29uc3RhbnRzGAMgAygLMh4uc3BlY3MuSWJhblNwZWNDb25zdGFudFBhdHRlcm5SCWNvbnN0YW50cw==');
...
final $typed_data.Uint8List ibanSpecDataDescriptor = $convert.base64Decode('CgxJYmFuU3BlY0RhdGESGgoIcG9zaXRpb24YASABKA1SCHBvc2l0aW9uEhYKBmxlbmd0aBgCIAEoDVIGbGVuZ3Ro');
@$core.Deprecated('Use ibanSpecFieldsDescriptor instead')
const IbanSpecFields$json = const {
  '1': 'IbanSpecFields',
  '2': const [
    const {'1': 'bank_code', '3': 1, '4': 1, '5': 11, '6': '.specs.IbanSpecData', '10': 'bankCode'},
    const {'1': 'account_number', '3': 2, '4': 1, '5': 11, '6': '.specs.IbanSpecData', '10': 'accountNumber'},
    const {'1': 'branch_code', '3': 3, '4': 1, '5': 11, '6': '.specs.IbanSpecData', '10': 'branchCode'},
    const {'1': 'account_type', '3': 4, '4': 1, '5': 11, '6': '.specs.IbanSpecData', '10': 'accountType'},
